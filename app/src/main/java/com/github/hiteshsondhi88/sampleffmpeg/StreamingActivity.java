...
OnCheckedChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mEditTextURI.setText(mPrefs.getString("uri", "rtsp://stream3.likes.com:1935/LikesLiveShows/nicktest.stream"));
	...
	protected void broadcastStream() {
		String origCommand = "-y -re -rtsp_flags listen -i ";
	...
	public void toggleStream() {
		...
		if (!mClient.isStreaming()) {
			...
			mClient.setServerAddress("127.0.0.1", 19093);
